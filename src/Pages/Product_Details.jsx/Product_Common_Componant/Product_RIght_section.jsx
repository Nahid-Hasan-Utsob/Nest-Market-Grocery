    ...
    <section className="w-full">
          ...
          <div className="flex w-4/6 justify-between my-4">
            <div>
              <div className="flex gap-2">
                <p className="menu-text-color quicksand-regular font-bold text-[13px] w-[50px]">
                  Brand:
                </p>
                <span className="primary-text-color text-[13px] font-bold quicksand-regular">
                  {brand}
                </span>
              </div>
              <div className="flex gap-2">
            ...
            <div>
              <div className="flex gap-2">
                <p className="menu-text-color quicksand-regular font-bold text-[13px] w-[110px]">
                  Availability:
                </p>
                <span className="primary-text-color text-[13px] font-bold quicksand-regular">
                  {availabilityStatus}
      ...
      <div className="mt-8 border-t border-gray-200 pt-4">
        ...
        <div className="flex gap-3 mb-4">
          <button
            ...
            className={`px-4 py-2 rounded-md font-semibold quicksand-regular transition duration-150 ${
              activeTab === "description"
                ? "primary-bg-color text-white text-[15px]"
                : "bg-gray-100 text-gray-700 text-[15px]"
            }`}
          >
            Description
          </button>
          ...
          <button
            ...
            className={`px-2 py-2 rounded-md font-semibold quicksand-regular transition duration-150 ${
              activeTab === "reviews"
                ? "primary-bg-color text-[15px] text-white"
                : "bg-gray-100 text-gray-700 text-[15px]"
            }`}
          >
        ...
        <div className="bg-white p-4 rounded-md shadow-sm min-h-[120px] transition-all duration-200">
          {activeTab === "description" && (
            <div>
              <h3 className="text-2xl  font-bold mb-2 menu-text-color quicksand-regular ">
                Product Description
              </h3>
                ...
                <ul className="grid grid-cols-4">
                  {reviewsSafe.map((r, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        className="border border-gray-200 rounded-2xl p-5 bg-white shadow-md hover:shadow-lg transition-all duration-300 quicksand-regular"
                      >
                        {/* Reviewer Info */}
                        <div className="mb-2">
                        ...
                        {/* Rating Stars */}
                        <div className="flex text-yellow-400 my-2 text-sm">
                        ...
                        {/* Review Comment */}
                        <p className="text-gray-700 text-[15px] leading-relaxed mt-2 border-t pt-3">
                          {comment}
                        </p>
                      </div>
                    );
